...
const METRICS = [
  { val: "Pending", label: "Brier Score",          note: "Target <0.10 — populating from May 2026 once T+90 grades accumulate." },
  { val: "Pending", label: "SI Coverage (90%)",    note: "Target >88% — sensitivity interval empirical coverage. Populating from Sep 2026." },
  { val: "Pending", label: "Tier-I Precision",     note: "Target >80% — populating from Sep 2026 once 30 Tier-I alerts have been graded." },
  { val: "Pending", label: "Tier-I Recall",        note: "Target >85% — populating from Sep 2026 once 10 Phase 4+ events have been graded." },
];
      ...
      <div className="methodology-layout" style={{ maxWidth: 1100, margin: "0 auto", width: "100%", display: "grid", gridTemplateColumns: "200px 1fr", padding: "0 40px", boxSizing: "border-box" }}>
        ...
        <article style={{ padding: "48px 0 80px 56px", minWidth: 0 }} className="methodology-article">
          ...
          <section id="overview" style={{ marginBottom: 64, paddingBottom: 64, borderBottom: "1px solid var(--border-light)", scrollMarginTop: 80 }}>
            ...
            <p style={s}>The system ingests six data streams covering rainfall, vegetation, conflict, food access, market prices, and displacement. These are synthesised by the <strong style={{ color: "var(--ink)" }}>Hypothesis Generation Engine (HGE)</strong> into ranked driver hypotheses, which feed a calibrated logistic model producing probabilistic risk scores at national level across 43 countries.</p>
          </section>
          ...
          <section id="model" style={{ marginBottom: 64, paddingBottom: 64, borderBottom: "1px solid var(--border-light)", scrollMarginTop: 80 }}>
            ...
            <div className="methodology-formula" style={{ background: "var(--parchment-dark)", border: "1px solid var(--border)", borderLeft: "3px solid var(--earth)", padding: "20px 24px", margin: "24px 0", fontFamily: "var(--mono)", fontSize: 13, color: "var(--ink)", lineHeight: 2, overflowX: "auto" }}>
              ...
              <br />
              <span style={{ color: "var(--ink-light)" }}>where σ is the logistic function, CSS is the composite stress score,<br />and coefficients β are expert-informed priors initialised from 87 country-season IPC transition records (AUC = 0.84 on held-out split). Full coefficient values are published in the arXiv paper and open-source repository.</span>
            </div>
