...
const PIPELINE_STEPS = [
  { n: "1", title: "Signal Ingestion",          desc: "Six data adapters ingest satellite, conflict, market, and displacement streams. Each adapter normalises its source to a shared 0.25° spatial grid (~28km cells) and ISO-week temporal cadence. Raw data is cached with source provenance and retrieval timestamp." },
...
const ARCHETYPES = [
  ...
  { type: "Economic/market",    signals: "WFP VAM, FAO GIEWS prices",     regions: "Urban centres, import-dependent regions" },
  { type: "Multi-causal",       signals: "All six core inputs",           regions: "Active conflict zones with drought overlay" },
];
      ...
      <div className="methodology-layout" style={{ maxWidth: 1100, margin: "0 auto", width: "100%", display: "grid", gridTemplateColumns: "200px 1fr", padding: "0 40px", boxSizing: "border-box" }}>
        ...
        <article style={{ padding: "48px 0 80px 56px", minWidth: 0 }} className="methodology-article">
          ...
          <section id="overview" style={{ marginBottom: 64, paddingBottom: 64, borderBottom: "1px solid var(--border-light)", scrollMarginTop: 80 }}>
            ...
            <p style={s}>The system ingests six core data streams covering rainfall (CHIRPS), vegetation (MODIS NDVI), conflict (UCDP GED), acute food insecurity phase (IPC), food access (WFP VAM), and market prices (FAO GIEWS), with FEWS NET outlooks used as a supplementary cross-check. These are synthesised by the <strong style={{ color: "var(--ink)" }}>Hypothesis Generation Engine (HGE)</strong> into ranked driver hypotheses, which feed a calibrated logistic model producing probabilistic risk scores at national level across 43 high-risk countries.</p>
          </section>
